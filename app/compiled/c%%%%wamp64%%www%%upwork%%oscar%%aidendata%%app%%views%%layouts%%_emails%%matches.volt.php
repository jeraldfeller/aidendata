...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title><?= $this->config->application->title ?> - <?= $this->config->application->mailDigestSubject ?></title>
    </head>
                        ...
                        <table class="container" style="border-spacing: 0; border-collapse: collapse; vertical-align: top; text-align: inherit; width: 510px; margin: 0 auto; padding: 0;"><tr style="vertical-align: top; text-align: left; padding: 0;" align="left"><td style="word-break: break-word; -webkit-hyphens: auto; -moz-hyphens: auto; hyphens: auto; border-collapse: collapse !important; vertical-align: top; text-align: left; color: #666666; font-family: 'Helvetica Neue', 'Arial', sans-serif; font-weight: normal; line-height: 19px; font-size: 14px; margin: 0; padding: 20px 0 30px;" align="left" valign="top">
                                    ...
                                    <table class="row" style="border-spacing: 0; border-collapse: collapse; vertical-align: top; text-align: left; width: 100%; position: relative; display: block; padding: 0px;"><tr style="vertical-align: top; text-align: left; padding: 0;" align="left"><td class="wrapper" style="word-break: break-word; -webkit-hyphens: auto; -moz-hyphens: auto; hyphens: auto; border-collapse: collapse !important; vertical-align: top; text-align: left; position: relative; color: #666666; font-family: 'Helvetica Neue', 'Arial', sans-serif; font-weight: normal; line-height: 19px; font-size: 14px; margin: 0; padding: 10px 20px 0px 0px;" align="left" valign="top">
                                                ...
                                                <table class="six columns" style="border-spacing: 0; border-collapse: collapse; vertical-align: top; text-align: left; width: 280px; margin: 0 auto; padding: 0;"><tr style="vertical-align: top; text-align: left; padding: 0;" align="left"><td style="word-break: break-word; -webkit-hyphens: auto; -moz-hyphens: auto; hyphens: auto; border-collapse: collapse !important; vertical-align: top; text-align: left; color: #666666; font-family: 'Helvetica Neue', 'Arial', sans-serif; font-weight: normal; line-height: 19px; font-size: 14px; margin: 0; padding: 0px 0px 10px;" align="left" valign="top">
                                                            <span class="logo" style="font-weight: 500; color: #375474; text-align: center; font-size: 23px; display: inline-block; padding: 10px 0;">Aiden Data</span>
                                                        </td>
                                                    ...
                                                    <table class="twelve columns" style="border-spacing: 0; border-collapse: collapse; vertical-align: top; text-align: left; width: 510px; margin: 0 auto; padding: 0;"><tr style="vertical-align: top; text-align: left; padding: 0;" align="left"><td class="text-pad" style="word-break: break-word; -webkit-hyphens: auto; -moz-hyphens: auto; hyphens: auto; border-collapse: collapse !important; vertical-align: top; text-align: left; color: #666666; font-family: 'Helvetica Neue', 'Arial', sans-serif; font-weight: normal; line-height: 19px; font-size: 14px; margin: 0; padding: 0px 10px 10px;" align="left" valign="top">
                                                                <p style="font-size: 15px; color: #666666; line-height: 22px; font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-weight: normal; margin: 0 0 10px; padding: 0;">
                                                                    ...
                                                                    <br style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 0;">
                                                                        Today we analysed <strong style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 0;"><?= $totalPdfs ?></strong> documents from <strong style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 0;"><?= $totalSources ?></strong> Councils and identified <?= $phrases ?> phrases that may be of interest to you.
                                                                </p>
                                                                <td class="expander" style="word-break: break-word; -webkit-hyphens: auto; -moz-hyphens: auto; hyphens: auto; border-collapse: collapse !important; vertical-align: top; text-align: left; visibility: hidden; width: 0px; color: #666666; font-family: 'Helvetica Neue', 'Arial', sans-serif; font-weight: normal; line-height: 19px; font-size: 14px; margin: 0; padding: 0;" align="left" valign="top"></td>
                                                        </tr></table>

                                                    <?php foreach ($scrapeSources as $scrapeSource) { ?>
                                                        <div style="max-width: 600px; display: block; font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0 auto; padding: 15px 0px 20px;">
                                                            <table bgcolor="" cellspacing="0" style="width: 100%; font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 0;" width="100%">
                                                                <tbody>
                                                                    <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 0;">
                                                                        <td style="vertical-align: top; font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 0 0 10px;" valign="top">
                                                                            <div style="color: #666666; font-weight: 600; font-size:18px; font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 0 0 0 0px;">
                                                                                <?= $this->escaper->escapeHtml($scrapeSource->name) ?>
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <?php foreach ($scrapeSource->Pdfs as $pdf) { ?>

                                                                        
                                                                        <?php if ($pdf->getUnprocessedMatches()->count() == 0) { ?>
                                                                            <?php continue; ?>
                                                                        <?php } ?>
                                                                        ...
                                                                        <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 0;">
                                                                            <td style="border-top-width: 3px; border-top-style: solid; border-top-color: #ECECEC; vertical-align: top; color: #252525; font-size: 14px; line-height: 23px; width: 40%; font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 10px 0;" valign="top">
                                                                                <a href="<?= $pdf->url ?>" class="item" style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 0; <?php if ($pdf->Matches->count() < 1) { ?>text-decoration: none; color:#666;<?php } ?>">
                                                                                   <?= basename($pdf->url) ?>
                                                                            </a><br/>
                                                                        </td>
                                                                        <td style="border-top-width: 3px; border-top-style: solid; border-top-color: #ECECEC; vertical-align: top; color: #252525; font-size: 14px; line-height: 23px; width: 60%; font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 10px 0;" valign="top">
                                                                            <div style="color: #666; text-align: right; font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; margin: 0; padding: 0;" align="right">
                                                                                Found <?= $pdf->Matches->count() ?> phrase(s)
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <?php foreach ($pdf->Matches as $match) { ?>
                                                                            <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 12px; margin: 0;">
                                                                                <td colspan=2 class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 13px; vertical-align: top; margin: 0; padding: 10px 10px 0;" valign="top">
                                                                                    <strong><em><?= $this->escaper->escapeHtml($match->Phrase->text) ?></em> was found on Page <?= $match->page + 1 ?></strong>
                                                                                </td>
                                                                            </tr>
                                                                            <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 11px; margin: 0;">
                                                                                <td colspan=2 class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 12px; vertical-align: top; margin: 0; padding: 0 10px 15px;" valign="top">
                                                                                    <em>[..] <?= $match->getHighlightedExcerptHtml() ?> [..]</em>
                                                                                </td>
                                                                            </tr>
                                                                        <?php } ?>
                                                                    </tr>
