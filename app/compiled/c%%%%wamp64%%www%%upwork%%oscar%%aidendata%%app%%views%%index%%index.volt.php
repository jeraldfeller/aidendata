...
<html class="no-js" lang="">
    <head>
        ...
        <link rel="shortcut icon" href="<?= $this->url->get('aiden/images/favicon.ico') ?>">

        <!-- stylesheets -->
        <link rel="stylesheet" type="text/css" href="<?= $this->url->get('aiden/scss/bootstrap/bootstrap.css') ?>" />
        <link rel="stylesheet" type="text/css" href="<?= $this->url->get('aiden/dist/theme.min.css') ?>" />
        ...
        <script src="<?= $this->url->get('aiden/dist/theme.min.js') ?>"></script>
    </head>
    <body>
        <!--[if lt IE 9]>
        ...
        <div class="business-hero">
            <div class="container">
                ...
                <div class="actions customFadeInUp">
                    <a href="<?= $this->url->get('login') ?>" class="btn-pill btn-pill-primary btn-pill-lg">Sign In</a>
                </div>
                <div class="">
                    <img style="margin-top: 24px; margin-bottom: 24px; width: 1000px; float:right;" src="<?= $this->url->get('images/macbook-pro.png') ?>">
                </div>
            </div>
